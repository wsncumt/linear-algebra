...
\usepackage{bbm}
\begin{document}
\newenvironment{add}{\kaishu\zihao{-5}\color{red}{\noindent\em 补充：}\par}{\hfill $\diamondsuit$\par}
...
(4)把(3)特征向量改造（施密特正交化，单位化）为$\gamma_1,\gamma_2,\gamma_3$;
