...
设$\alpha_{1},\alpha_{2},\alpha_{3}$是非齐次线性方程组$Ax=b$得到解，若$\sum\limits_{i=1}^{3}c_{i}\alpha_{i}$也是$Ax=b$得到解，则$\sum\limits_{i=1}^{3}c_{i}=$\underline{\hphantom{~~~~~~~~~~}}。\\

\num 期末2015-2016 四2.

设向量组$\alpha_{1},\alpha_{2},\alpha_{3}$线性无关，向量$\beta$可由$\alpha_{1},\alpha_{2},\alpha_{3}$线性表示，向量$\gamma$不能由$\alpha_{1},\alpha_{2},\alpha_{3}$线性表示，证明向量组$\alpha_{1},\alpha_{2},\alpha_{3},\beta+\alpha$线性无关。\\
